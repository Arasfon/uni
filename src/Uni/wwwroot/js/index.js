...
function switchMenuOnOuterClick(e) {
    const element = e.target;
    if (element instanceof HTMLElement && element.classList.contains("nav-menu__links-wrapper")) {
        switchMenu();
    }
}
function switchMenu() {
    const linksWrapper = document.querySelector(".nav-menu__links-wrapper");
